...
#[AsController]
class PatchUserActiveGroupController
{
    ...
    public function __invoke(
        #[MapRequestPayload] PatchUserActiveGroup $data,
        Context $context,
    ): JsonResponse {
        ...
        $this->messageBus->dispatch(new UpdateUserActiveGroup(
            userId: $user->getId(),
            patchUserActiveGroup: $data
        ));
